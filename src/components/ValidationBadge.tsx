...
const levelConfig = {
  BASICO: {
    ...
    description: 'Todavía falta cargar la documentación',
    Icon: Icons.User,
  },
  VERIFICADO: {
    label: 'DNI validado',
    ...
    description: 'La identidad ya fue validada con DNI',
  ...
  DESTACADO: {
    ...
    description: 'Perfil con buenas reseñas de anfitriones',
    Icon: Icons.Award,
  },
  PREMIUM: {
    label: 'Presencial',
    ...
    description: 'Anfitrión con validación en persona',
    Icon: Icons.Crown,
  },
};
