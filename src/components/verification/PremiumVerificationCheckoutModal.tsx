          ...
          <div className="mt-6 space-y-5">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-800/50">
                <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-slate-400">Precio actual</p>
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-800/50">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-700 dark:text-slate-200">Más contexto visible para que otros entiendan mejor el respaldo de tu perfil o de tu aviso.</p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-800/50">
                <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-slate-400">Impacto esperado</p>
            ...
            <div className="rounded-[24px] border border-slate-200 bg-slate-50 p-5 dark:border-slate-800 dark:bg-slate-800/50">
              ...
              <div className="mt-3 space-y-3 text-sm leading-6 text-slate-700 dark:text-slate-200">
                <p>1. Confirmás el precio o el cupo sin cargo.</p>
                <p>2. Registramos la mejora en tu cuenta.</p>
                <p>3. Te redirigimos al proceso de verificación correspondiente.</p>
              </div>
            </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
                    {offer.purchased || offer.completed
                      ? 'La mejora ya está activa. Podés seguir directo al proceso de verificación.'
                      : 'Confirmamos el monto y te llevamos directo al proceso, sin pasos extra.'}
                  </p>
                </div>
