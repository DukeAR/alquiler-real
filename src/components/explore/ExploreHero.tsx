          ...
          <div className="flex w-full max-w-[980px] flex-col items-center text-center">
            ...
            >
              {valueProofItems.map((item) => (
                <span
                  key={item}
                  className="inline-flex items-center gap-2 rounded-full border border-white/70 bg-white/90 px-3.5 py-2 text-[0.82rem] font-semibold text-slate-700 shadow-sm backdrop-blur-md transition-all duration-200 hover:-translate-y-0.5 hover:bg-white sm:px-4.5 sm:py-2.5 sm:text-[0.95rem]"
                >
