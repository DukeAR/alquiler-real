      ...
      <div className="relative overflow-hidden rounded-[calc(var(--app-radius-display)+4px)] border border-white/75 bg-slate-950 shadow-[0_28px_60px_-40px_rgba(15,23,42,0.28)]">
        {backgroundImage ? (
          <div className="pointer-events-none absolute inset-0">
            ...
            />
            <div className="absolute inset-0 bg-[linear-gradient(96deg,rgba(255,255,255,0.95)_8%,rgba(252,253,255,0.82)_34%,rgba(245,248,251,0.54)_62%,rgba(238,242,246,0.28)_100%)]" />
            <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.18)_0%,rgba(255,255,255,0.06)_42%,rgba(246,248,251,0.12)_100%)]" />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_78%_34%,rgba(239,244,248,0.18)_0%,rgba(239,244,248,0)_44%)]" />
          </div>
        ) : null}
