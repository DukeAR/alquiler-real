...
export const OnsiteVerificationPage: React.FC<OnsiteVerificationPageProps> = ({ onBack }) => {
  ...
  return (
    ...
    >
      ...
      <main className="mx-auto flex max-w-4xl flex-col gap-7 px-6 py-6 md:gap-8 md:py-8">
        ...
        <section className="space-y-4 border-t border-slate-200/85 pt-7 dark:border-slate-800">
          ...
          <div className="grid gap-6 md:grid-cols-2 md:gap-10">
            <div className="space-y-3 border-l-2 border-slate-200 pl-4 dark:border-slate-800">
              <h3 className="text-[1rem] font-semibold text-slate-900 dark:text-slate-100">Sin verificación</h3>
              <ul className="space-y-2.5 text-[0.96rem] leading-6 text-slate-600 dark:text-slate-400">
            ...
            <div className="space-y-3 border-l-2 border-brand pl-4">
              <h3 className="text-[1rem] font-semibold text-slate-900 dark:text-slate-100">Con verificación</h3>
              <ul className="space-y-2.5 text-[0.96rem] leading-6 text-slate-700 dark:text-slate-300">
        ...
        <section className="space-y-4 border-t border-slate-200/85 pt-7 dark:border-slate-800">
          ...
          <ul className="space-y-2.5 text-[0.96rem] font-medium text-slate-800 dark:text-slate-200">
        ...
        <section className="space-y-3 border-t border-slate-200/85 pt-7 dark:border-slate-800">
          <div className="space-y-2">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">Sello</p>
            <h2 className="text-[1.55rem] font-semibold leading-[1.08] tracking-[-0.04em] text-slate-950 dark:text-slate-50">
              Sello Verificado presencialmente
            </h2>
            <p className="max-w-lg text-[0.96rem] leading-6 text-slate-600 dark:text-slate-400">
        ...
        <section className="space-y-4 border-t border-slate-200/85 pt-7 dark:border-slate-800 md:pt-8">
          ...
          <div className="max-w-2xl space-y-3">
            <div className="aspect-video overflow-hidden rounded-[18px] border border-dashed border-slate-300/90 bg-[radial-gradient(circle_at_center,rgba(67,56,202,0.08),transparent_46%),linear-gradient(180deg,rgba(248,250,252,0.98),rgba(241,245,249,0.94))] dark:border-slate-700 dark:bg-slate-950">
        ...
        <section className="space-y-4 border-t border-slate-200/85 pt-7 dark:border-slate-800 md:pt-8">
          <div className="max-w-xl space-y-2">
            <h2 className="text-[1.9rem] font-semibold leading-[1.05] tracking-[-0.04em] text-slate-950 dark:text-slate-50 md:text-[2.2rem]">
