...
export const demoProperties: Property[] = [
  ...
  buildDemoProperty({
    id: '5',
    title: 'Departamento simple con patio interno y cocina cómoda',
    location: 'Mar del Tuyú',
    price: 46000,
    propertyType: 'Departamento',
    description: 'Alternativa simple para una estadía corta, con patio interno y distribución funcional.',
    imageUrl: 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=1200&q=80',
    hostName: 'Carolina Benítez',
    hostId: 'demo-host-5',
    identityValidated: false,
    locationVerified: false,
    propertyRelationshipVerified: false,
  ...
  buildDemoProperty({
    id: '6',
    title: 'Casa económica con patio lateral y cocina básica',
    location: 'Las Toninas',
    price: 43000,
    propertyType: 'Casa',
    description: 'Publicación simple para estadías cortas, con patio lateral y equipamiento básico. Todavía no tiene validaciones visibles dentro de la plataforma.',
    imageUrl: 'https://images.unsplash.com/photo-1560185008-b033106af5c3?auto=format&fit=crop&w=1200&q=80',
    hostName: 'Carolina Benítez',
    hostId: 'demo-host-5',
    identityValidated: false,
    locationVerified: false,
  ...
  buildDemoProperty({
    id: '7',
    title: 'PH nuevo con entrada independiente y comedor chico',
    location: 'Nueva Atlantis',
    price: 39500,
    propertyType: 'PH',
    description: 'PH recién publicado, pensado para escapadas tranquilas. Aún no suma identidad validada ni verificación presencial.',
