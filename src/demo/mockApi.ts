...
const createDemoStore = (): DemoStore => {
  ...
  const validationData: ValidationData = {
    ...
    progress: 80,
    levelNumber: 4,
    levelLabel: '4 de 5 validaciones visibles',
    shortLabel: '4/5',
    nextLevel: 'Completar validación documental',
    verificationScore: 4,
    headline: 'Tu cuenta ya muestra la mayor parte de la información validada disponible.',
    ...
    benefits: {
      current: [
        'Tu perfil ya muestra información validada básica.',
    ...
    premiumDocumentaryOffer: {
      ...
      summary: 'Sumá DNI y selfie como información validada extra para tu perfil.',
...
const updateValidationAfterDocumentaryCompletion = () => {
  store.validationData = {
    ...
    level: 'COMPLETO',
    levelNumber: 5,
    levelLabel: '5 de 5 validaciones visibles',
    shortLabel: '5/5',
    nextLevel: null,
    verificationScore: 5,
    summary: 'Tu cuenta ya muestra toda la información validada disponible dentro de la plataforma.',
