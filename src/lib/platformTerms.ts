...
export const PLATFORM_TERMS_QUICK_GUIDE_INTRO = 'Lo importante en 1 minuto: quién publica, qué hace la plataforma, cuándo puede revisar un caso y cuándo no.';
...
export const PLATFORM_TERMS_QUICK_GUIDE_SECTIONS: PlatformTermsQuickGuideSection[] = [
  ...
  },
  {
    ...
    body: 'La seña queda registrada, hay trazabilidad y la plataforma puede revisar lo asentado para ayudar a evaluar cómo sigue.',
  },
  {
    id: 'outside-platform',
  ...
  },
  {
    ...
    body: 'Puede revisar información registrada dentro de la app, pero no garantiza devoluciones automáticas en todos los casos ni actúa como juez absoluto.',
  },
  {
    id: 'data-and-validation',
    title: 'Datos y validación',
    body: 'Puede recibir documentos, imágenes, videos o datos de ubicación para validar o revisar casos. Lo sensible no se muestra públicamente.',
  },
];
...
export const PLATFORM_TERMS_HIGHLIGHTS = [
  ...
  'Las comprobaciones ayudan a revisar mejor, pero no garantizan por sí solas el estado final del lugar ni la experiencia completa.',
] as const;
...
export const PLATFORM_TERMS_CLAUSES: PlatformTermsClause[] = [
  {
    ...
    body: 'Alquiler Real conecta personas, ordena el proceso de reserva y deja registro de lo que pasa dentro de la app. No actúa como dueña del alojamiento, inmobiliaria ni garante total de la experiencia.',
  },
  {
    id: 'property-information',
    eyebrow: 'Propiedades',
    title: 'Lo que muestra cada aviso',
    body: 'La información, las fotos, los servicios, las reglas y las descripciones de cada propiedad son proporcionadas por el anfitrión. Alquiler Real puede mostrar comprobaciones o historial visible, pero no garantiza coincidencia total entre lo publicado y la realidad del lugar.',
  },
  {
  ...
  },
  {
    ...
    body: 'Si el conflicto se vincula con información o acciones registradas dentro de la app, Alquiler Real puede revisar lo asentado y ayudar a evaluar el caso. Esa revisión no implica una garantía automática de devolución ni convierte a la plataforma en juez absoluto de cualquier disputa.',
  },
  {
...
export const PLATFORM_PROPERTY_DISCLAIMER = 'La información del aviso la carga el anfitrión. Las comprobaciones ayudan a revisar mejor, pero no garantizan el estado final del lugar.';
...
export const PLATFORM_PROTECTED_FLOW_NOTE = 'Si más adelante dejan la seña dentro de la app, ese tramo queda registrado y la plataforma puede revisar lo asentado dentro de ese flujo.';